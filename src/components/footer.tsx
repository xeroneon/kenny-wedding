    ...
    <footer className="flex flex-col xl:flex-row justify-between items-start w-full bg-sky-700 text-white py-4 px-6">
      <div className="w-full xl:w-3/4">
        <p className="block xl:hidden text-sm leading-normal">
          Enjoy special rates at Tenaya Lodge! Use promo code <strong className="text-yellow-500">BOYKEN(J25)</strong>.
        </p>
        <p className="hidden xl:block leading-normal">
          We have a block of rooms reserved at Tenaya Lodge in Yosemite. Use our group code <strong className="text-yellow-500">BOYKEN(J25)</strong> for special rates. Book by April 1st to secure your room. We can't wait to celebrate with you in this gorgeous setting!
        </p>
      </div>
